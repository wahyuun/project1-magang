...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between">
        <h5 class="d-inline">Kamu dapat memodifikasi akun sesuai dengan kolom yang tersedia.</h5>
    </div>
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item">
                    ...
                    ><i class="bx bx-user-plus me-1"></i> Tambah Akun</a
                    >
                </li>
                {{-- <li class="nav-item">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        src=""
                        alt="user-avatar"
                        class="d-block rounded d-block img-preview"
                        height="100"
                        width="100"
                        id="uploadedAvatar"
                        />
                    ...
                    <form id="formAccountSettings" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="firstName" class="form-label">Nama Depan (nama tengah)</label>
